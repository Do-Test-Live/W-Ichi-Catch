...
<body class="home-body" style="min-height: 100vh">
<div class="navbar">
    ...
    <div class="container intro-text-section mt-3 pt-5 pb-5">
        <div class="col-12">
            <table class="table">
                ...
                <tbody>
                <?php
                $fetch_gift = $db_handle->runQuery("select * from customer_gifts where customer_id = '$userId'");
                $no_fetch_gift = $db_handle->numRows("select * from customer_gifts where customer_id = '$userId'");
